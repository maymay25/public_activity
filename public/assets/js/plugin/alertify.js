...
var Log = (function () {
    ...
    var Log,
        ...
        clsRemove = prefix + " is-" + prefix + "-remove";
    ...
    Log.prototype.close = function () {
        ...
        if (typeof this.el !== "undefined" && this.el.parentNode === this.parent) {
            if (transition.supported) {
                ...
                this.el.className = clsRemove + " " + prefix + "-" + this.type;
            } else {
                remove.call(this);
            }
        }
    ...
    Log.prototype.create = function () {
        if (typeof this.el === "undefined") {
            $(".alertify-log").hide().remove();
            var el = element.create("article", {
                classes: clsHide + " " + prefix + "-" + this.type
            });
            el.innerHTML = '<div class="alertify-log-inner"><div class="message-inner">'+this.msg+'</div></div>';
    ...
    Log.prototype.show = function () {
        ...
        var width = $(".alertify-log:eq(0)").width();
        var mleft = (350-width)/2;
        $(".alertify-log:eq(0)").animate({marginLeft:''+mleft+'px'},250);
