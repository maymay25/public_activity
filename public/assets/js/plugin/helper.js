define(['underscore', 'backbone', 'jquery'], function (_, Backbone, $) {
    ...
    /************************************************************************************/
    /* jq操作cookie
    /* $.cookie('name', 'test',{expires: 7}); 设置cookies
    /* $.cookie('name'); 取得cookies
    /* $.cookie('name', null);
    /************************************************************************************/
    ...
    /*
     * 任务管理器类
     * @param processFn {Function} 处理程序
     * @param callback {Function} 任务处理完后的回调
    ...
    window.helper = {
        ...
        */
         ...
         * type:1-新浪，2-qq
         * baidu:百度统计
         * callback:登录成功回调，若没有callbakc则刷新页面
         * */
        ...
        */
        ...
        /*
        * 截取指定长度的字符串 str {String} 原始字符串 len {Number} 长度 s {String}
        * 超过指定长度后加后缀。默认为""。可以加"..."
        */
        ...
        */
        ...
        scrollTo1: function (top, offset) {
            $("html, body").animate({ scrollTop: top + offset }, 120);
        },
